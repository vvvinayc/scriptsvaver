...
<head>
    ...
    <title>Fusion SCRIPT</title>
</head>
<body class="body">
<div>
    <button><a href="view_page.php">HOME</a></button>
...
<table class="table_child">
  ...
  $Client_name = 'NAFA';
  $sqlfetch= "Select * from scripts  where Client_name = 'FUSION' and is_deleted = 0 order by script_code desc";
