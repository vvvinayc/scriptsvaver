...
disabled value="<?php echo  $script_type?>">
<label for="remarks">Remarks: </label><input type="text" name="remarks" id="remarks" placeholder="" size="26" autocomple="off"
disabled value="<?php echo $remarks?>">
<br><br>
<label for="script">Here is your Script:</label> <br>
<textarea name="script"  id="script" cols="120" rows="28" required disabled>
<?php echo $sql_script?>
</textarea>
